...
module.exports = class DbService {
    ...
    mediaArray(result) {
        ...
        for (var i = 0; i < result.length; i++) {
            var t = result[i]
            //, buttons: [{ type: "postback", title: t[Object.keys(t)[0]], payload: t[Object.keys(t)[0]] + "_" + t[Object.keys(t)[2]] }]
            array.push({ title: t[Object.keys(t)[0]], subtitle: "", image_url: t[Object.keys(t)[1]] });
        }
